...
{
  /*printf("_A_min_0 =%d,  _A_min_1=%d,  _A_min_2=%d, \
 ...
 float _shiftReg_A_stencilRadius_0_stencil[41];
 (void)0;
 uint _0 = (uint)(10);
 ...
 {
  for (int _inputA_s1_row = -2; _inputA_s1_row < -2 + 12; _inputA_s1_row++)
  {
   for (int _inputA_s1_col = 0; _inputA_s1_col < 0 + 10; _inputA_s1_col++)
   {
     printf("\n t=%d row=%d,col=%d ",_inputA_s1_time , _inputA_s1_row, _inputA_s1_col );
    
 #pragma unroll 
 for (int shiftI = 1 ; shiftI < 41; shiftI++) {
    _shiftReg_A_stencilRadius_0_stencil[shiftI-1]=_shiftReg_A_stencilRadius_0_stencil[shiftI];
}
        int _15 = _inputA_s1_row + 2;
    uint _16 = (uint)(10);
    int _17 = _15 * _16;
    ...
    printf(" input[%d]=%.1f", _27, _28);

_shiftReg_A_stencilRadius_0_stencil[41-1]=_28;
    (void)0;
    bool _29 = 2 <= _inputA_s1_col;
    bool _30 = _inputA_s1_col <= 7;
    bool _31 = _29 && _30;
    bool _32 = 2 <= _inputA_s1_row;
    bool _33 = _inputA_s1_row <= 7;
    bool _34 = _32 && _33;
    bool _35 = _31 && _34;
    if (_35)
    {
     ...
     for (int _inputA_s1_stencilRadius__x = -2; _inputA_s1_stencilRadius__x < -2 + 5; _inputA_s1_stencilRadius__x++)
     {
       int _36 = _inputA_s1_stencilRadius__x + 20;
       float _37 = _shiftReg_A_stencilRadius_0_stencil[_36];
       int _38 = _inputA_s1_stencilRadius__x * 10;
       int _39 = _38 + 20;
     ...
     printf(" %d=%.1f", _55, _reduction_temp_updateinputA);
    } // if _35
   } // for _inputA_s1_col
  } // for _inputA_s1_row
 } // for _inputA_s1_time
